...
const LoginPage = () => {
    ...
    const handleInputChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            const { data, error: authError } = await authAPI.signIn(formData.email, formData.password);
            ...
            if (data.user) {
                ...
                const { onboarding_completed } = await authAPI.checkOnboardingStatus(data.user.id);
        ...
        try {
            ...
            if (error) {
                ...
                if (error.message.includes('provider is not enabled')) {
                    setError('Login dengan Google belum diaktifkan. Silakan hubungi administrator.');
            ...
            <div className="max-w-md w-full space-y-8">
                ...
                <div className="text-center">
                    ...
                    <p className="mt-2 text-gray-300">
                        Akses koleksi chord favorit Anda
                    </p>
                </div>                {/* Login Form */}
                <div className="bg-white rounded-lg shadow-xl p-8 border-t-4 border-[#00FFFF]">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <Link href="/reset-password" className="text-sm text-[#00FFFF] hover:text-[#1A2A3A] transition-colors">
                                Lupa password?
                            </Link>
                        </div>
